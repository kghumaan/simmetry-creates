...
The client gate is `ADMIN_PASSWORD` at the top of `js/admin.jsx`; the server
checks the `ADMIN_PASSWORD` environment variable (falls back to `1111`).
Set the env var in Vercel and update the constant to change it.
